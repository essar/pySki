...
class DMSCoordinate:
    ...
    def __init__(self, lat_d, lat_m, lat_s, lon_d, lon_m, lon_s):
        ...
        self.longitude = DMSElement(lon_d, lon_m, lon_s, lonX)
...
def add_seconds(degrees, decimal_mins):
...
def tester():
    ...
    latDrift = wgs.get_latitude_degrees() - wgs2.get_latitude_degrees()
    lonDrift = wgs.get_longitude_degrees() - wgs2.get_longitude_degrees()
